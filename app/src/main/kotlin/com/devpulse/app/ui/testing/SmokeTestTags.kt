...
object SmokeTestTags {
    ...
    fun subscriptionTagGroupHeader(tag: String?): String {
        val normalized = tag?.trim().orEmpty().ifBlank { "untagged" }.lowercase()
        return "subscriptions_tag_group_header_$normalized"
    }
